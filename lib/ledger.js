...
// Lives here rather than alongside the feed components because both server
// pages call it to work out which sections a ledger contains. Exports from a
// 'use client' module become client references, so calling one during a server
// render throws — this has to sit in a plain module both sides can import.
